...
try {
    if ($marcar_todas) {
        ...
        // CORREÇÃO 1: incluir 'PENDENTE_PIX' junto com 'AGENDADA', igual ao
        // filtro usado em contar_notificacoes.php e notificacoes.php.
        // CORREÇÃO 2: removida a limitação de 7 dias (c.data_agendada <=
        // CURRENT_DATE + INTERVAL '7 days'), que ignorava coletas agendadas
        // mais à frente (ex: coleta de item marcada para 9+ dias depois).
